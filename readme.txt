...
Step3: Deploying LSTM to gcloud platform
       ...
       2. Steps to follow while creating LSTM gcloud project:
            ...
            7. Then, on cmd terminal type "set =KEY_PATH" (Replace KEY_PATH with the path of the JSON file that contains your service account key.)
